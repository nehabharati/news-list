...
const India = () => {
    ...
    useEffect(() => {
        const getPosts = async () => {
            setLoading(true)
            const results = await axios.get("https://newsapi.org/v2/top-headlines?country=ca&apiKey=028a318abd9e4364b0a32f66b822287b&pageSize=100", { crossdomain: true });
    ...
    return (
        <div className="content-container">
            <h1 className="my-5 text-primary text-center">Top news in Canada</h1>
